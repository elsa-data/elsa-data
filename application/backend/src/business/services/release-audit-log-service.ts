...
@injectable()
export class ReleaseAuditLogService {
  ...
  public async getEntries(
    ...
    console.log(
      `${ReleaseAuditLogService.name}.getEntries(releaseId=${releaseId}, limit=${limit}, offset=${offset}) -> total=${totalEntries}, pageOfEntries=...`
    );

          ...
          ? [
              {
                ...
                recordedDateTime: entry.recordedDateTime.toISOString(),
                updatedDateTime: entry.updatedDateTime.toISOString(),
                occurredDateTime: entry.occurredDateTime.toISOString(),
  ...
  public async getFullEntry(
    ...
    if (!entry || !entry.data || entry.data.length === 0) {
      ...
      return {
        ...
        recordedDateTime: entry.data[0].recordedDateTime.toISOString(),
        updatedDateTime: entry.data[0].updatedDateTime.toISOString(),
        occurredDateTime: entry.data[0].occurredDateTime.toISOString(),

...
npx pbjs --es6 -p ../../../../GA4GH/phenopacket-schema/src/main/proto phenopackets/schema/v2/phenopackets.proto -t static-module -w es6 -o src/generated/phenopackets.js

 ...
 * @constructor
 */
export const VirtualCohortBox: React.FC<Props> = ({}) => {
  const [lastMutateError, _setLastMutateError] = useState<string | null>(null);
  ...
  const ctrlUrlMutate = useMutation({
    mutationFn: axiosPostArgMutationFn<{ type: string }>(

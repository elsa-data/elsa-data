...
export const AustralianGenomicsDacDialog: React.FC<Props> = ({
  ...
  const createNewReleaseMutate = useMutation((d: AustraliaGenomicsDacRedcap) =>
    axios
      .post<AustraliaGenomicsDacRedcap[]>(`/api/dac/redcap/new`, d)
              ...
              <Dialog.Panel className="relative bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:max-w-3xl sm:w-full">
                  ...
                  <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                    ...
                    <div className="mt-2 prose">
                      <p className="text-sm text-gray-500">
                        This is a list of applications in the Australian
                        Genomics Redcap instance that are
                    ...
                    <table className="w-full table-auto text-sm mt-4">
                      <tbody>
                        {possibleApplications &&
                          possibleApplications
                            .sort((a, b) =>
                              a.application_date_hid.localeCompare(
                                b.application_date_hid
                              )
                            )
                            .map((pa) => (
                              <tr>
                                ...
                                <td className="border p-2">
                                  {pa.application_date_hid}
                                </td>
                                <td className="border p-2">
                                  {pa.daf_applicant_name}
                                </td>
                                <td className="border p-2">
                                  {pa.daf_project_title}
                                </td>
                              </tr>
                            ))}
                      </tbody>
                ...
                <div className="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                  <button
                    ...
                    onClick={() => {
                      createNewReleaseMutate.mutate(possibleApplications[0], {
                        onSuccess: () => {

...
export const format7807Error = (error: Base7807Response): JSX.Element | undefined => {
...
export const formatErrorDetailWithMessage = (error: any): JSX.Element | undefined => {
  return <>
...
export const formatError = (
  ...
  if (!navigator.onLine) {
    return <ErrorBox styling={styling}>
